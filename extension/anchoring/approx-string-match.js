/* Vendored: approx-string-match 2.0.0 (MIT, Robert Knight)
 * https://github.com/robertknight/approx-string-match-js
 * Verbatim build/src/index.js except: ESM export converted to a
 * globalThis.inspegAnchoring registration (content scripts are classic
 * scripts). Never hand-edit the algorithm — re-vendor to update.
 * License: see approx-string-match.LICENSE (MIT). */
/**
 ...
 */
function approxStringSearch(text, pattern, maxErrors) {
    const matches = findMatchEnds(text, pattern, maxErrors);
    return findMatchStarts(text, pattern, matches);
}

globalThis.inspegAnchoring = globalThis.inspegAnchoring || {};
globalThis.inspegAnchoring.approxSearch = approxStringSearch;
